...
void main() {
  // 1. تشغيل المحرك الرسومي أولاً لضمان عدم ظهور شاشة سوداء
  WidgetsFlutterBinding.ensureInitialized();
  
  // 2. تشغيل التطبيق فوراً
  runApp(const FlexYemenApp());

  // 3. محاولة الاتصال بسوبابيس في الخلفية (Asynchronous)
  _initSupabase();
}
...
Future<void> _initSupabase() async {
  try {
    ...
    debugPrint("Supabase loaded in background with error: $e");
  }
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor: Colors.black, // تأمين اللون الأسود الملكي للخلفية
        primaryColor: const Color(0xFFD4AF37),
        fontFamily: 'Tajawal',
      ),
      home: const HomeScreen(), // سيعرض واجهة الهوم فوراً
    );
  }
}
